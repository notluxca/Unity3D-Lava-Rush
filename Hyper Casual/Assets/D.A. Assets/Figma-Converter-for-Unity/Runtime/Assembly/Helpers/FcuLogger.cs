...
namespace DA_Assets.FCU
{
    ...
    {
        public static void Debug(object log, FcuDebugSettingsFlags logType = FcuDebugSettingsFlags.LogDefault)
        {
        ...
        {
            if (requestCount != 0 && requestCount % FcuConfig.ApiRequestsCountLimit == 0)
            {
                if (remainingTime > 0)
                {
                    DALogger.Log(log);
